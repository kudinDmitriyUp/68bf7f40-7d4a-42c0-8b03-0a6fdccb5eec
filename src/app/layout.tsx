...
export const metadata: Metadata = {
  title: "Casa Ka'an Calakmul - Luxury Jungle Lodge Mexico",
  description: "Discover luxury in the heart of nature at Casa Ka'an, a boutique jungle lodge in Calakmul Biosphere Reserve. Experience pristine wilderness, fine dining, and authentic Maya culture.",
  keywords: "luxury hotel Calakmul, jungle lodge Mexico, boutique resort, wellness retreat, eco-luxury accommodation",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766055302087-sg1rnur1.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766055302087-sg1rnur1.jpg"
  },
  openGraph: {
    title: "Casa Ka'an Calakmul - Your Jungle Paradise Awaits",
    description: "Exclusive jungle lodge combining luxury comfort with authentic nature experiences in Mexico's pristine Calakmul reserve.",
    type: "website",
    siteName: "Casa Ka'an Calakmul",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766055302087-sg1rnur1.jpg",
      alt: "Casa Ka'an luxury lodge in Calakmul jungle"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Casa Ka'an Calakmul - Luxury Jungle Lodge",
    description: "Experience ultimate luxury in the heart of the jungle",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766055302087-sg1rnur1.jpg"]
  }
};
